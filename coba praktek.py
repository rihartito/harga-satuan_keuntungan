#Nama:Rihar del tito-71200648
#Universitas Kristen Duta Wacana 
#Variable, Expression dan Statements
#https://zaendarma.wordpress.com/
...
#input : jumlah = 2 lusin (24) ; harga = Rp 240000 ; persen = 25 %(0.25)

#proses : 
1.mencari satuan 
2.keuntungan yang ingin diraih 
3.harga teh gelas untuk dijual 

#output :
harga satuan teh gelas ; keuntungan ; harga teh gelas untuk dijual 
